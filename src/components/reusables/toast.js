...
const AquaToast = () => {
  ...
  const getIconAndColor = (type) => {
    switch (type) {
      ...
      default:
        return {
          icon: <CheckCircleIcon className="h-6 w-6 text-gray-400" aria-hidden="true" />,
  ...
  return (
    ...
    >
      <div className="flex w-full flex-col items-center space-y-4 sm:items-end">
        ...
        >
          <div className={`pointer-events-auto w-full max-w-sm overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 ${color}`}>
            <div className="p-4">

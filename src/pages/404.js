    ...
    <>
      ...
      <main className="relative min-h-screen w-full overflow-hidden bg-slate-50 selection:bg-emerald-200 selection:text-emerald-900 flex items-center justify-center p-4">
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-[-10%] left-[-10%] w-[60vw] h-[60vw] rounded-full bg-emerald-200/20 blur-[120px] animate-pulse" />
          <div className="absolute bottom-[-10%] right-[-10%] w-[60vw] h-[60vw] rounded-full bg-indigo-200/20 blur-[120px] animate-pulse delay-1000" />
        ...
        >
          ...
          <div className="-mt-12 mb-8 relative z-20">
            ...
            <p className="mt-2 text-sm text-slate-500 max-w-xs mx-auto">
              While you're here, why not beat our AI in a quick game of
              Tic-Tac-Toe?
            </p>
          </div>

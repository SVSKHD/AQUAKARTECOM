...
return(
  ...
  <button
    type="button"
    className="relative inline-flex items-center rounded-l-md bg-sky-900 px-3 py-2 text-sm font-semibold text-white ring-1 ring-inset ring-gray-300 hover:bg-sky-800 focus:z-10"
  ...
  <button
    type="button"
    className="relative -ml-px inline-flex items-center rounded-r-md bg-sky-900 px-3 py-2 text-sm font-semibold text-white ring-1 ring-inset ring-gray-300 hover:bg-sky-800 focus:z-10"

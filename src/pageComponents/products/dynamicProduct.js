...
export default function AquaDynamicProductComponent() {
  ...
  const seo = {
    ...
    keywords: `Aquakart Products Aquakart ${productData.title} , kent products, Aquakart producsts`,
    description: productData?.description.substring(0, 200),
    canonical: `${process.env.NEXT_PUBLIC_URL}${router.asPath}`,
    photos: `${productData?.photos ? productData?.photos[0].secure_url : LOGO}`,
                  ...
                  >
                    ...
                    >
                      ...
                      <div
                        ...
                        style={{
                          backgroundImage: `url(${productData?.category?.photos[0]?.secure_url})`,
                        }}
                      ></div>

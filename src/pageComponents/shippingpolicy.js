...
export default function AquaShippingPolicyComponent() {
  ...
  const seo = {
    ...
    keywords:
      "online ecom privacy store , Privacy policy store , online shopping, Free Shipping, Shipping Policy, International Shipping, Same Day Shipping",
        ...
        <div className="mx-auto max-w-7xl px-6 text-center lg:px-8">
          <div className="mx-auto max-w-2xl">
            ...
            <p className="mt-4 text-lg leading-8 text-gray-400">
              “Fast and reliable delivery. Our shipping policy ensures your
              orders reach you safely and on time.”
            </p>
          </div>
          <ul
            role="list"
